...
def deltaSpecPpv():
    ...
    shutil.copyfile("rplot.png","static/rplot.png")
...
def deltaSpPpv():
    ...
    if os.path.isfile("rplot.png"):
        os.remove("rplot.png")
    if os.path.isfile("static/rplot.png"):
        os.remove("static/rplot.png")
    else:
        print "no static/rplot.png file "
    # Generate the GRAPH
    ...
    shutil.copyfile(str(keyUnique[1])+"rplot.png","static/"+str(keyUnique[1])+"rplot.png")
    print "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
    print " callback function 1 >> " + callBackFunction[1];
    print returnString  
    print "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
...
if __name__ == '__main__':
    ...
    #app.run(host='analysistools-dev.nci.nih.gov',port=8086,debug = True)
#    app.run(host='156.40.114.41',port=8086,debug = True)
