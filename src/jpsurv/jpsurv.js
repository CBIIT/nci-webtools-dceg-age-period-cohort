...
function get_plot() {
	...
	$("#plot-image").attr('src', 'output-'+getUrlParameter('keyId')+'.png');
...
function change_covariate_select() {
	console.log("CHANGING COVARIATE SELECT");
	console.log('change_covariate_select');
	console.dir(cohort_covariance_variables);
